      ...
      <Modal.Header className={classes.Modal}>
        <Tabs defaultActiveKey={defaultTab} className={classes.Tabs}>
          <Tab
            eventKey="login"
            title="Login"
            tabClassName={[classes.Tab, classes.LoginTab].join(" ")}
          >
          ...
          <Tab
            eventKey="register"
            title="Register"
            tabClassName={[classes.Tab, classes.RegisterTab].join(" ")}
          >
